...
var DateRange_1 = __webpack_require__(13);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Browser_1 = __webpack_require__(28);
...
var DataObject = (function () {
    ...
    DataObject.prototype.assignFromObject = function (sourceObj) {
        ...
        if (Utils_1.JsonUtils.isExists(sourceObj.id)) {
            this.id = String(sourceObj.id);
            this.internalId = String(sourceObj.id);
        }
    };
    DataObject.prototype.generateId = function () {
...
var TaskAreaManager = (function () {
    ...
    TaskAreaManager.prototype.initMouseEvents = function () {
        ...
        this.ganttView.taskArea.addEventListener("mousewheel", function (evt) { _this.onMouseWheel(evt); });
    ...
    TaskAreaManager.prototype.onTaskAreaClick = function (evt) {
        if (!this.preventSelect) {
            ...
            if (this.ganttView.settings.allowSelectTask) {
                var clickedTaskID = this.ganttView.viewModel.tasks.items[clickedTaskIndex].internalId;
                this.ganttView.unselectCurrentSelectedTask();
                this.ganttView.selectTask(clickedTaskID);
                this.ganttView.ganttOwner.changeGanttTaskSelection(clickedTaskID, true);
            }
            if (this.time && now.getTime() - this.time.getTime() < TaskAreaManager.DBLCLICK_INTERVAL) {
                var clickedTask = this.ganttView.viewModel.tasks.items[clickedTaskIndex];
                this.ganttView.commandManager.showTaskEditDialog.execute(clickedTask);
            }
            this.time = now;
        }
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var CollectionBase_1 = __webpack_require__(5);
...
Object.defineProperty(exports, "__esModule", { value: true });
var HistoryItemState_1 = __webpack_require__(59);
...
var TaskTitleManipulator = (function (_super) {
    ...
    TaskTitleManipulator.prototype.setPropertyValue = function (task, value) {
        task.title = value;
        this.dispatcher.notifyTaskTitleChanged(task.internalId, value);
    };
...
var TaskDescriptionManipulator = (function (_super) {
    ...
    TaskDescriptionManipulator.prototype.setPropertyValue = function (task, value) {
        ...
        this.dispatcher.notifyTaskDescriptionChanged(task.internalId, value);
    };
...
var TaskProgressManipulator = (function (_super) {
    ...
    TaskProgressManipulator.prototype.setPropertyValue = function (task, value) {
        task.progress = value;
        this.dispatcher.notifyTaskProgressChanged(task.internalId, value);
    };
...
var TaskStartDateManipulator = (function (_super) {
    ...
    TaskStartDateManipulator.prototype.setPropertyValue = function (task, value) {
        task.start = value;
        this.dispatcher.notifyTaskStartChanged(task.internalId, value);
    };
...
var TaskEndDateManipulator = (function (_super) {
    ...
    TaskEndDateManipulator.prototype.setPropertyValue = function (task, value) {
        task.end = value;
        this.dispatcher.notifyTaskEndChanged(task.internalId, value);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var HandlerStateBase_1 = __webpack_require__(67);
var Point_1 = __webpack_require__(3);
var DomUtils_1 = __webpack_require__(2);
...
var Point_1 = __webpack_require__(3);
var DomUtils_1 = __webpack_require__(2);
var MouseHandlerStateBase_1 = __webpack_require__(16);
...
Object.defineProperty(exports, "__esModule", { value: true });
var HistoryItem_1 = __webpack_require__(7);
...
var DialogBase = (function (_super) {
    ...
    DialogBase.prototype.execute = function (options) {
        var _this = this;
...
Object.defineProperty(exports, "__esModule", { value: true });
var RecurrenceBase_1 = __webpack_require__(9);
var DateTimeUtils_1 = __webpack_require__(1);
...
var DateUtils = (function () {
    ...
    DateUtils.getOffsetInQuarters = function (start, end) {
        return (end.getFullYear() - start.getFullYear()) * 4 + Math.trunc(end.getMonth() / 3) - Math.trunc(start.getMonth() / 3);
    };
...
var ElementTextHelper = (function () {
    ...
    ElementTextHelper.prototype.getQuarterScaleItemText = function (scaleItemDate, isViewTypeScale) {
        ...
        var yearDisplayText = !isViewTypeScale ? scaleItemDate.getFullYear().toString() : "";
        return this.getMonthsScaleItemTextCore(quarterNames[Math.trunc(scaleItemDate.getMonth() / 3)], yearDisplayText);
    };
...
var TaskEditController = (function () {
    ...
    Object.defineProperty(TaskEditController.prototype, "taskId", {
        get: function () {
            return this.gantt.viewModel.tasks.items[this.taskIndex].internalId;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TaskEditController.prototype, "successorId", {
        get: function () {
            return this.gantt.viewModel.tasks.items[this.successorIndex].internalId;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TaskEditController.prototype, "task", {
        get: function () {
            return this.gantt.viewModel.tasks.items[this.taskIndex];
        },
        enumerable: true,
        configurable: true
    });
    ...
    TaskEditController.prototype.processEnd = function (position) {
        ...
        this.showTimeMessage(startDate, date);
    };
    TaskEditController.prototype.confirmEnd = function () {
        this.baseElement.className = TaskEditController.CLASSNAMES.TASK_EDIT_BOX;
        this.editing = false;
        var width = this.baseElement.clientWidth;
        var startDate = this.task.start;
        var date = this.gantt.gridLayoutCalculator.getDateByPos(width + this.baseElement.offsetLeft);
        date.setSeconds(0);
        if (date < startDate)
            date.setTime(startDate.getTime());
        this.gantt.commandManager.changeTaskEndCommand.execute(this.taskId, date);
        this.updateWrapInfo();
    };
    TaskEditController.prototype.processStart = function (position) {
        ...
        this.showTimeMessage(date, endDate);
    };
    TaskEditController.prototype.confirmStart = function () {
        this.baseElement.className = TaskEditController.CLASSNAMES.TASK_EDIT_BOX;
        this.editing = false;
        var endDate = this.task.end;
        var date = this.baseElement.clientWidth > 1 ? this.gantt.gridLayoutCalculator.getDateByPos(this.baseElement.offsetLeft) : endDate;
        date.setSeconds(0);
        this.gantt.commandManager.changeTaskStartCommand.execute(this.taskId, date);
        this.updateWrapInfo();
    };
    ...
    TaskEditController.prototype.confirmMove = function () {
        this.baseElement.className = TaskEditController.CLASSNAMES.TASK_EDIT_BOX;
        var left = this.baseElement.offsetLeft;
        var date = this.gantt.gridLayoutCalculator.getDateByPos(left);
        date.setSeconds(0);
        var deltaDate = this.task.start.getTime() - date.getTime();
        var endTime = new Date();
        endTime.setTime(this.task.end.getTime() - deltaDate);
        if (this.editing) {
            this.gantt.history.beginTransaction();
            this.gantt.commandManager.changeTaskStartCommand.execute(this.taskId, date);
            this.gantt.commandManager.changeTaskEndCommand.execute(this.taskId, endTime);
    ...
    TaskEditController.prototype.endDependency = function (type) {
        this.editing = false;
        if (type)
            this.gantt.commandManager.createDependencyCommand.execute(this.task.id, this.successorId, type);
    ...
    TaskEditController.prototype.showTimeMessage = function (start, end) {
        ...
        startEl.append(startTitle);
        startEl.append(this.formatDate(start));
        var endEl = document.createElement("DIV");
        var endTitle = document.createElement("SPAN");
        endTitle.innerHTML = "End: ";
        endEl.append(endTitle);
        endEl.append(this.formatDate(end));
        timeElement.append(startEl);
        timeElement.append(endEl);
        this.statusMsg.append(timeElement);
        this.statusMsg.style.display = "block";
        if (this.statusTimerId)
            clearTimeout(this.statusTimerId);
        this.statusTimerId = setTimeout(function () {
...
var GridLayoutCalculator_1 = __webpack_require__(55);
var EtalonSizeValues_1 = __webpack_require__(56);
var TaskEditController_1 = __webpack_require__(30);
var TaskAreaManager_1 = __webpack_require__(6);
var ModelManipulator_1 = __webpack_require__(57);
var History_1 = __webpack_require__(62);
var EventManager_1 = __webpack_require__(63);
var TaskAreaContainer_1 = __webpack_require__(73);
var Settings_1 = __webpack_require__(74);
var ModelChangesDispatcher_1 = __webpack_require__(75);
var TaskPropertiesHistoryItem_1 = __webpack_require__(18);
var TaskHistoryItem_1 = __webpack_require__(31);
...
var GanttView = (function () {
    ...
    GanttView.prototype.createTaskVisualElement = function (index) {
        ...
        taskElement.addEventListener("mouseenter", function (evt) { this.onTaskElementHover(evt); }.bind(this));
        return taskElement;
    };
    GanttView.prototype.onTaskElementHover = function (evt) {
        var y = DomUtils_1.DomUtils.getEventY(evt);
        var taskAreaY = DomUtils_1.DomUtils.getAbsolutePositionY(this.taskArea);
        var relativeY = y - taskAreaY;
        var hoveredTaskIndex = Math.floor(relativeY / this.tickSize.height);
        this.taskEditController.show(hoveredTaskIndex);
    };
    ...
    GanttView.prototype.unselectTask = function (id) { this.viewModel.changeTaskSelected(id, false); };
    ...
    GanttView.prototype.setTaskTitle = function (taskId, newValue) {
        ...
        if (task)
            this.history.addAndRedo(new TaskPropertiesHistoryItem_1.TaskTitleHistoryItem(this.modelManipulator, task.internalId, newValue));
    };
    GanttView.prototype.setTaskProgress = function (taskId, newValue) {
        var task = this.getTaskByPublicId(taskId);
        if (task)
            this.history.addAndRedo(new TaskPropertiesHistoryItem_1.TaskProgressHistoryItem(this.modelManipulator, task.internalId, newValue));
    };
    GanttView.prototype.setTaskStart = function (taskId, newValue) {
        var task = this.getTaskByPublicId(taskId);
        if (task)
            this.history.addAndRedo(new TaskPropertiesHistoryItem_1.TaskStartHistoryItem(this.modelManipulator, task.internalId, newValue));
    };
    GanttView.prototype.setTaskEnd = function (taskId, newValue) {
        var task = this.getTaskByPublicId(taskId);
        if (task)
            this.history.addAndRedo(new TaskPropertiesHistoryItem_1.TaskEndHistoryItem(this.modelManipulator, task.internalId, newValue));
    };
    GanttView.prototype.removeTask = function (taskId) {
        var task = this.getTaskByPublicId(taskId);
        if (task)
            this.history.addAndRedo(new TaskHistoryItem_1.RemoveTaskHistoryItem(this.modelManipulator, task.internalId));
    };
    GanttView.prototype.createTask = function (parentId) {
        ...
        var item = new TaskHistoryItem_1.CreateTaskHistoryItem(this.modelManipulator, start, end, "", parentId);
        this.history.addAndRedo(item);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var ResourceCollection_1 = __webpack_require__(11);
...
var Task = (function (_super) {
    ...
    Task.prototype.assignFromObject = function (sourceObj) {
        if (Utils_1.JsonUtils.isExists(sourceObj)) {
            ...
            this.parentId = String(sourceObj.parentId);
...
var GridLayoutCalculator = (function () {
    ...
    GridLayoutCalculator.prototype.getRangeTickCountInQuarterViewType = function (start, end) {
        var startQuarterStartDate = new Date(start.getFullYear(), Math.trunc(start.getMonth() / 3) * 3, 1);
        var endQuarterStartDate = new Date(end.getFullYear(), Math.trunc(end.getMonth() / 3) * 3, 1);
    ...
    GridLayoutCalculator.prototype.getDateByPos = function (position) {
        ...
        if (this.viewType == Enums_1.ViewType.Months || this.viewType == Enums_1.ViewType.Quarter) {
            var monthFromStart = Math.trunc(preResult);
...
Object.defineProperty(exports, "__esModule", { value: true });
var DependencyManipulator_1 = __webpack_require__(58);
var ResourcesManipulator_1 = __webpack_require__(60);
var TaskManipulator_1 = __webpack_require__(61);
...
Object.defineProperty(exports, "__esModule", { value: true });
var TaskPropertiesManipulator_1 = __webpack_require__(15);
var TaskDependencyManipulator = (function (_super) {
    ...
    TaskDependencyManipulator.prototype.insertDependency = function (predecessorId, successorId, type) {
        ...
        this.dispatcher.notifyDependencyInserted(dependency);
    ...
    TaskDependencyManipulator.prototype.removeDependency = function (dependencyId) {
        ...
        this.dispatcher.notifyDependencyRemoved(dependency);
        this.viewModel.updateVisibleItemDependencies();
        this.viewModel.owner.resetAndUpdate();
        return dependency;
    };
...
var ResourcesManipulator = (function (_super) {
    ...
    ResourcesManipulator.prototype.create = function (text, id) {
        ...
        this.dispatcher.notifyResourceCreated(resource);
        return resource;
    };
    ResourcesManipulator.prototype.remove = function (resourceId) {
        ...
        this.dispatcher.notifyResourceRemoved(resource);
        return resource;
    };
    ResourcesManipulator.prototype.assign = function (resourceID, taskId) {
        ...
        this.dispatcher.notifyResourceAssigned(assignment);
    ...
    ResourcesManipulator.prototype.deassig = function (assignmentId) {
        ...
        this.dispatcher.notifyResourceDeassigned(assignmentId);
        this.viewModel.updateModel();
        this.viewModel.owner.resetAndUpdate();
        return assignment;
    };
...
var TaskManipulator = (function (_super) {
    ...
    TaskManipulator.prototype.create = function (start, end, title, parentId, id) {
        ...
        this.viewModel.updateModel();
        this.dispatcher.notifyTaskCreated(task);
        this.viewModel.owner.resetAndUpdate();
        return task;
    };
    TaskManipulator.prototype.remove = function (taskId) {
        ...
        this.dispatcher.notifyTaskRemoved(task);
        this.viewModel.updateModel();
        this.viewModel.owner.resetAndUpdate();
        return task;
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var MouseHandler_1 = __webpack_require__(64);
var DomUtils_1 = __webpack_require__(2);
var KeyCode_1 = __webpack_require__(72);
var Browser_1 = __webpack_require__(28);
...
Object.defineProperty(exports, "__esModule", { value: true });
var HandlerBase_1 = __webpack_require__(65);
var TaskAreaManager_1 = __webpack_require__(6);
var TaskEditController_1 = __webpack_require__(30);
var MouseHandlerDefaultState_1 = __webpack_require__(66);
var DomUtils_1 = __webpack_require__(2);
var MouseHandlerMoveTaskState_1 = __webpack_require__(68);
var MouseHandlerProgressTaskState_1 = __webpack_require__(69);
var MouseHandlerTimestampTaskState_1 = __webpack_require__(70);
var MouseHandlerDependencyState_1 = __webpack_require__(71);
var MouseHandler = (function (_super) {
    ...
    MouseHandler.prototype.onMouseUp = function (evt) {
        this.control.isFocus = DomUtils_1.DomUtils.GetIsParent(this.control.mainElement, DomUtils_1.DomUtils.getEventSource(evt)) ? true : false;
...
Object.defineProperty(exports, "__esModule", { value: true });
var MouseHandlerDragTaskBaseState_1 = __webpack_require__(17);
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventDispatcher_1 = __webpack_require__(76);
var ModelChangesDispatcher = (function () {
    ...
    ModelChangesDispatcher.prototype.notifyTaskCreated = function (task) {
        this.onModelChanged.raise("NotifyTaskCreated", task);
    };
    ModelChangesDispatcher.prototype.notifyTaskRemoved = function (task) {
        this.onModelChanged.raise("NotifyTaskRemoved", task);
    };
    ...
    ModelChangesDispatcher.prototype.notifyDependencyInserted = function (dependency) {
        this.onModelChanged.raise("NotifyDependencyInserted", dependency);
    };
    ModelChangesDispatcher.prototype.notifyDependencyRemoved = function (dependency) {
        this.onModelChanged.raise("NotifyDependencyRemoved", dependency);
    };
    ModelChangesDispatcher.prototype.notifyResourceCreated = function (resource) {
        this.onModelChanged.raise("NotifyResourceCreated", resource);
    };
    ModelChangesDispatcher.prototype.notifyResourceRemoved = function (resource) {
        this.onModelChanged.raise("NotifyResourceRemoved", resource);
    };
    ModelChangesDispatcher.prototype.notifyResourceAssigned = function (assignment) {
        this.onModelChanged.raise("NotifyResourceAssigned", assignment);
    };
    ModelChangesDispatcher.prototype.notifyResourceDeassigned = function (assignmentID) {
        this.onModelChanged.raise("NotifyResourceDeassigned", assignmentID);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var TaskCommands_1 = __webpack_require__(78);
    ...
    RemoveTaskCommand.prototype.executeInternal = function (id) {
        ...
        if (dependencies.length)
            if (this.control.settings.editing.allowDependencyDeleting)
                dependencies.forEach(function (d) { return _this.history.addAndRedo(new TaskDependencyHistoryItem_1.RemoveDependencyHistoryItem(_this.modelManipulator, d.id)); });
            else
                return false;
        var assignments = this.control.viewModel.assignments.items.filter(function (a) { return a.taskId == id; });
        assignments.forEach(function (a) { return _this.history.addAndRedo(new ResourceHistoryItem_1.DeassignResourceHistoryItem(_this.modelManipulator, a.id)); });
