...
var FileManager = function(_Widget) {
    ...
    _createClass(FileManager, [{
        ...
        value: function() {
            ...
            this._notificationControl = this._createComponent($notificationControl, _uiFile_manager9.default, {
                ...
                contentTemplate: function(container) {
                    return _this2._createWrapper(container)
                },
                onActionProgress: function(e) {
                    return _this2._onActionProgress(e)
                }
            });
        ...
        value: function($container) {
            ...
            this._breadcrumbs = this._createComponent($breadcrumbs, _uiFile_manager13.default, {
                ...
                onPathChanged: function(e) {
                    return _this6._setCurrentPath(e.newPath)
                },
        ...
        value: function() {
            ...
            this._controller.refresh().then(function() {
        ...
        value: function() {
            ...
            if (this.option("itemView.showParentFolder") && !selectedDir.fileItem.isRoot) {
                var parentDirItem = new _file_provider.FileManagerItem(null, "..", true);
                parentDirItem.isParentFolder = true;
                itemInfos = (0, _deferred.when)(itemInfos).then(function(items) {
                    var itemInfosCopy = [].concat(_toConsumableArray(items));
        ...
        value: function() {
            return (0, _extend.extend)(_get(FileManager.prototype.__proto__ || Object.getPrototypeOf(FileManager.prototype), "_getDefaultOptions", this).call(this), {
                fileProvider: null,
                currentPath: "",
                rootFolderName: _message2.default.format("dxFileManager-rootFolderName"),
        ...
        value: function(_ref6) {
            var fileItemInfo = _ref6.fileItemInfo;
