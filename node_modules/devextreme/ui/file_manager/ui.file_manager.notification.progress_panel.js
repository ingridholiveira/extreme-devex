...
var FileManagerProgressPanel = function(_Widget) {
    ...
    _createClass(FileManagerProgressPanel, [{
        ...
        value: function() {
            ...
            (0, _renderer2.default)("<div>").text("Progress").addClass(FILE_MANAGER_PROGRESS_PANEL_TITLE_TEXT_CLASS).appendTo($title);
            ...
            this._$infosContainer = (0, _renderer2.default)("<div>").text("No operations").addClass(FILE_MANAGER_PROGRESS_PANEL_INFOS_CONTAINER_CLASS).appendTo($container)
        }
    }, {
        ...
        value: function(ratio, value) {
            return 1 === ratio ? "Done" : Math.round(100 * ratio) + "%"
        }
    }, {
