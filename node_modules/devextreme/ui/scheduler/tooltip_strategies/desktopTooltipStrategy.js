    ...
    _createClass(TooltipManyAppointmentsBehavior, [{
        ...
        value: function(e) {
            ...
            if (this.scheduler._allowDragging()) {
                var data = e.itemData.data;
                _events_engine2.default.on(e.itemElement, _drag2.default.start, function(e) {
                    return _this3._onDragStart(e, data)
                });
                _events_engine2.default.on(e.itemElement, _drag2.default.move, function(e) {
                    return _this3._onDragMove(e)
                });
                _events_engine2.default.on(e.itemElement, _drag2.default.end, function(e) {
                    return _this3._onDragEnd(e, data)
                })
            }
        }
    }, {
        ...
        key: "_onDragStart",
        value: function(e, itemData) {
            this.state.appointment = this._createDragAppointment(itemData, itemData.settings);
            this.state.initPosition = this._createInitPosition(this.state.appointment, {
                top: e.pageY,
                left: e.pageX
            });
            _translator2.default.move(this.state.appointment, this.state.initPosition);
            var appointments = this._getAppointmentsInstance();
        ...
        key: "_removeAppointmentIfDragEndOnCurrentCell",
        value: function(itemData) {
            var newCellIndex = this.scheduler._workSpace.getDroppableCellIndex();
            var oldCellIndex = this.scheduler._workSpace.getCellIndexByCoordinates(this.state.initPosition);
            if (newCellIndex === oldCellIndex) {
                this.getAppointmentsInstance()._clearItem({
                    itemData: itemData
                })
            }
        }
