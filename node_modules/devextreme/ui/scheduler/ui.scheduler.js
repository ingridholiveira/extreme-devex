...
var Scheduler = _ui4.default.inherit({
    ...
    _initTemplates: function() {
        ...
        this._defaultTemplates.appointmentPopup = new _empty_template.EmptyTemplate;
    ...
    _initDynamicPopupTemplate: function(appointmentData, processTimeZone) {
        var that = this;
        this._defaultTemplates.appointmentPopup = new _function_template.FunctionTemplate(function(options) {
    ...
    _popupConfig: function(appointmentData) {
        ...
        return {
            ...
            contentTemplate: new _function_template.FunctionTemplate(function(options) {
